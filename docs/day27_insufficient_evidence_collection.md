...
No safety-limit bypass, no hard collision, no power-loss intervention, no camera/data
corruption, and no multiple-primary interventions. Unexpected contact, safety abort,
or hardware fault remains an exclusion and raw attempt. Task success is retained and
the same s06 is recollected without changing the assigned variant.
